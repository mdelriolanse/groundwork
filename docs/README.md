...
| [DEMO-AND-PITCH.md](DEMO-AND-PITCH.md) | Beats, 5-min script, citation traps |
| [BUILD-PLAN.md](BUILD-PLAN.md) | Clock + teammate seats |
| [LANDMINES.md](LANDMINES.md) | Do-not list |
| [SOURCES.md](SOURCES.md) | URLs behind the claims |
